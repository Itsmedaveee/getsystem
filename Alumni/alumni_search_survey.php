        ...
        <div class="navbox">
            ...
            <div class="multi-level">
                ...
                <div class="item">
                    ...
                    <img src="../img/emaildropdown5.png" class="arrow"><label for="A">Surveys</label>
                    <ul>
                ...
                <div class="item">
                    ...
                    <img src="../img/emaildropdown5.png" class="arrow"><label for="B">Jobs</label>
                    <ul>
         ...
         <div class="statuspanel">
           ...
           <CAPTION><h3>Manage Users</h3></CAPTION>
            ...
            <a href='Add_grad_survey' class='print_grad' style=''><i class='fa fa-plus'></i> Add Survey</a>
                ...
                $queryn = mysqli_query($conn, "SELECT * FROM sent_surveytbl WHERE batch ='$batch'");
                $total_countn = mysqli_num_rows($queryn);
                ...
                if ($total_countn == 0) {
                    ...
                    $sql = "SELECT * from mysurveytbl WHERE $filter LIKE '%$searchdb%' AND User_ID ='$db_id' limit $start_from,$num_per_page ";
