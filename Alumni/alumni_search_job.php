         ...
         <div class="statuspanel">
           ...
           <CAPTION><h3>Job Offerings</h3></CAPTION>
            ...
            <button onclick="Addgrad()" class="addenum" style="margin:0; padding:4; background:#2e68aa; color:aliceblue; border:0; border-radius: 3px 3px 3px 3px; cursor:pointer;"><img src="" alt=""><i class="fa fa-briefcase"></i> My Job Offerings</button>
                ...
                $queryn = mysqli_query($conn, "SELECT * FROM job_offeringtbl");
                ...
                if ($total_count == 0) {
                    ...
                    $sql = "SELECT * from job_offeringtbl WHERE $filter LIKE '%$searchdb%' order by JID desc limit $start_from,$num_per_page ";
            ...
            //******************************SHOWING Survey TABLE <img src='../img/responsewhite.png'> <img  src='../img/questionwhite.png'>  <img src='../img/Addreswhite.png'> <img src='../img/delete1.png'>*/
                ...
                ?>
                        ...
                        function Addgrad(){
                                window.location.href='alumni_my_post';
                            }
