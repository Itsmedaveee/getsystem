            ...
            <input type="submit" class="searchbtn" name="search" value="Filter">
                ...
                if(isset($_POST['search'])){
                   ...
                   if(isset($_GET['filt'])) {
                       ...
                       $searchdb = preg_replace("#[^0-9a-z@. ]#i","",$searchdb);
                        ...
                        $query = mysqli_query($conn, "SELECT * FROM mysurveytbl WHERE $filter LIKE '%$searchdb%' AND user_ID = $db_id ");
                        ...
                        $sql = "SELECT Survey_ID, Title, Description, Date_created, End_date, Status, Respondents FROM mysurveytbl WHERE $filter LIKE '%$searchdb%' AND user_ID = $db_id limit $start_from,$num_per_page ";
                ...
                //******************************SHOWING Survey TABLE   */
                            echo "<tbody><tr height=30>
                                    ...
                                    <td width='125px'>
                                    <a class='toolq' href='Questionnaire?jScript=$jScript && newScript=$newScript && getQuestion=$getQuestion && ID=$db_id && SID=$surveyID' >
                                    <img  src='../img/questionnaire.png'></a>
                                    ...
                                    <img src='../img/Addresponse.png'></a>
                                    <span class='tooltipe'>Add Response</span>
                                    <a class='toold' href=' ?jScript=$jScript && newScript=$newScript && getEdit=$getEdit && ID=$db_id' >
