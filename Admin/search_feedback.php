        ...
        <div class="navbox">
         ...
         <div class="statuspanel">
           ...
           <CAPTION><h3>List of Employers</h3></CAPTION>
            ...
            <a href='emp_add_survey' class='print_grad' style=''><i class='fa fa-trash-alt'></i> Delete all</a>
             <table border="0" width="500" align="center"class="table-stripped" >
                ...
                //***************************Update button code start here */ 
                    ...
                    $sql = "SELECT * from employer_respondenttbl WHERE $filter LIKE '%$searchdb%' order by EMP_ID desc limit $start_from,$num_per_page ";
                    ...
                    if ($result-> num_rows > 0){
                       ...
                       <a class='toolr' href='send_emp_survey?jScript=$jScript && newScript=$newScript && getQuestion=$getQuestion && EMPID=$EMP_ID && GID=$GID' >
                       <i class='fa fa-comment'></i></a>
                       <span class='tooltips'>View Feedback</span>
