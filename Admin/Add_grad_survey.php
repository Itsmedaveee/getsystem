...
if (isset($_POST['submit_btn'])) {
    ...
    mysqli_query($conn, "INSERT INTO mysurveytbl(user_ID,Title,Description,date_created,End_date,Status,Respondents,Survey_type) VALUES('$db_id','$title','$description','$date_now','$enddate','Active','$respondents','graduates')");
                
    echo "<script>window.location.href='graduates_survey?$encrypted&&notify=Survey Added Successfully!';</script>";
    }
...
if (isset($_POST['cancel_btn'])) {
    $encrypted = md5(rand(1,9));
        ...
        echo "<script>window.location.href='graduates_survey?$encrypted';</script>";
         ...
         <?php 
           ...
           <div class="div-tab">
                <div class="cpasspanel">
                    ...
                    <input type="date" name="enddate" class="dinput" style="width:210px;" value="<?php echo $_POST['enddate']; ?>">
