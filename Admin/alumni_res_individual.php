           ...
           <div class="headcontainer">
                ...
                <div class="bodycontainer">
                    ...
                    <?php 
                      ...
                      echo  "<div class='divNote'>
                                    ...
                                    <button name='addQbtn' class='addbtn'><a href='Add_Questionnaire?$encrypt$encrypt1$encrypt2&&SID=$surveyID'><img src='../img/addQ.png' alt=''> Add Questionnaires</a></button>
                        ...
                        $sqltotal = "SELECT * FROM admin_respondenttbl WHERE Survey_ID='$surveyID'";
                        $resulttotal = $conn-> query($sqltotal);
                        $totalcount = $resulttotal-> num_rows;
                        $sqlrespondent = "SELECT * FROM admin_respondenttbl WHERE Survey_ID='$surveyID' LIMIT $start_from,$num_per_page";
                        $resultrespondent = $conn-> query($sqlrespondent);
                            
                            if ($resultrespondent-> num_rows > 0){
                                    
                                    while ($rowrespondent = $resultrespondent-> fetch_assoc()){
                                            $ARID = $rowrespondent['AR_ID'];
                                            $batch = $rowrespondent['batch'];
                                            $studno = $rowrespondent['stud_no'];
                                            $fullname = $rowrespondent['name'];
                                            $datetime = $rowrespondent['date']." @ ".$rowrespondent['time'];
                        
                            $queryres = mysqli_query($conn, "SELECT * FROM admin_responsetbl where AR_ID=$ARID");
                            $result = mysqli_num_rows($queryres);
                            $fetchres = mysqli_fetch_assoc($queryres);
                            
                    ?>
                                <div class='divNote' style="text-align:center;">
                                <?php 
                                ...
                                ?>
                                    <a <?php echo $hideprev; ?> href="alumni_res_individual?<?php echo $encrypt.$encrypt1.$encrypt2; ?>&&page=<?php echo $page - 1; ?>&&SID=<?php echo $surveyID; ?>" class="prev">
                                    <img src="../img/next.png" alt=""></a>   
                                    <p class='NoteText'>Date Answered: <?php echo $datetime; ?><br>
                                    <span class='NoteText'><?php echo $fullname; ?> / <?php echo $studno; ?></span><br>
                                    <span class='NoteText'>Batch - <?php echo $batch; ?></span>
                                    </p>
                                ...
                                ?>
                                    <a <?php echo $hidenext; ?> href="alumni_res_individual?<?php echo $encrypt.$encrypt1.$encrypt2; ?>&&page=<?php echo $page + 1; ?>&&SID=<?php echo $surveyID; ?>" class="next">
                                    <img src="../img/next.png" alt=""></a>
                        ...
                        <!---================================== Question No. 1 Short Answer =============================--->
                            ...
                            <span class="Answerlabel" style="margin-left:-15px;">Answer(s):</span>
                                        <?php 
                                        $sql1 = "SELECT * FROM admin_responsetbl WHERE Question_ID='$QID' LIMIT $start_from,$num_per_page";
                ...
                <!-=====================Footer Done button ------>
                            <div class='divFooter'>
                                    ...
                                    <button name='addQbtn' class='addbtn'><a href='alumni_response_record?<?php echo $encrypted;?>&&SID=<?php echo $surveyID;?>'>BACK</a></button>
