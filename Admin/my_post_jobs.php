        ...
        <div class="mainpanel">
            ...
            <button onclick="Addgrad()" class="addenum" style="margin:0; padding:4; background:#2e68aa; color:aliceblue; border:0; border-radius: 3px 3px 3px 3px; cursor:pointer;"><img src="" alt=""><i class="fa fa-briefcase"></i> All Job Offerings</button>
                ...
                //***************************Showing all enumerators */ 
                        $query = mysqli_query($conn, "SELECT * FROM job_offeringtbl WHERE UID = $db_id");
                        ...
                        $sql = "SELECT * FROM job_offeringtbl WHERE UID = $db_id order by JID desc limit $start_from,$num_per_page ";
                        ...
                        if ($result-> num_rows > 0){
                            ...
                            echo "<tbody><tr height=30>
                                   ...
                                   <button onClick='editme($JID)' class='bt-edit'>
                ...
                ?>
                        ...
                        <?php
                            ...
                            echo "<script>window.location.href='search_my_jobs?filt=".$preg_rep."&&cat=".$_POST['filter']."';</script>";
                        ...
                        if (confirm("Youre about to delete Alumni, continue?")) {
                            ...
                            function editme(JID){
                                window.location.href='update_post?JID='+JID+'';
                            }
                            function printgrad(){
