...
if (isset($_POST['cancel_btn'])) {
    $encrypted = md5(rand(1,9));
        ...
        echo "<script>window.location.href='emp_question?$encrypted&&SID=$surveyID';</script>";
        ...
        if (empty($_POST['questionn'])) {
            ...
            if (empty($_POST['options'])) {
                ...
                $newpwerr = "Please Enter Choices!";
                        ...
                        echo "<script>window.location.href='emp_add_question?SID=$surveyID&&notify=Question($question) Added Successfully!';</script>";
                        }
            }
...
// Add Short Answer question button
    if (isset($_POST['AddShortbtn'])) {
        ...
        echo "<script>window.location.href='emp_add_question?SID=$surveyID&&notify=Question[$inputShortText] Added Successfully!';</script>";
        }
...
// Add Long Answer question button
    if (isset($_POST['AddLongbtn'])) {
        ...
        echo "<script>window.location.href='emp_add_question?SID=$surveyID&&notify=Question[$inputLongText] Added Successfully!';</script>";
        }
...
// Add Date button
    if (isset($_POST['AddDatebtn'])) {
        ...
        echo "<script>window.location.href='emp_add_question?SID=$surveyID&&notify=Question[$inputDateText] Added Successfully!';</script>";
        }
