           ...
           <CAPTION><h3>Manage Users</h3></CAPTION>
            ...
            <input type="submit" class="searchbtn" name="search" value="Filter">
                ...
                //***************************Update button code start here */ 
                    ...
                    $query = mysqli_query($conn, "SELECT * FROM userstb WHERE $filter LIKE '%$searchdb%' AND account_type !='1'");
                    ...
                    $sql = "SELECT ID, Name, Contact, Email, account_type, Password from userstb WHERE $filter LIKE '%$searchdb%' AND account_type !='1' limit $start_from,$num_per_page ";
                    ...
                    if ($result-> num_rows > 0){
                        ...
                        echo "<tbody><tr height=30>
                                ...
                                <td width='30px'><div class='divtype'>$acc_type</div></td>
                                
                                <td width='80px'><a href=' ?jScript=$jScript && newScript=$newScript && getUpdate=$getUpdate && ID=$db_id' class='bt-update'>
