    ...
    <header>
        ...
        <div class="navbox">
         ...
         <?php 
           ...
           <CAPTION><h3>Graduate Surveys</h3></CAPTION>
            ...
            <a href='Add_grad_survey' class='print_grad' style=''><i class='fa fa-plus'></i> Add Survey</a>
                <table border="0" width="100%" align="center"class="table-stripped" >
                    ...
                    <button class='toolr' onClick='sendme(35)'>
                                   ...
                                   <button class='toolre' onClick='reset(35)'>
                                   <i class='fa fa-undo-alt'></i></button>
                                   <span class='tooltipre'>Reset</span>
                ...
                //***************************Showing all Surveys  */ 
                        ...
                        $sql = "SELECT Survey_ID, Title, Description, Date_created, End_date, Status, Respondents FROM mysurveytbl WHERE user_ID = $db_id AND Survey_ID !='35' AND Survey_type = 'graduates' ORDER BY Survey_ID DESC limit $start_from,$num_per_page";
                ...
                ?>
                        ...
                        /**Search button */
                            ...
                            echo "<script>window.location.href='search_surveys?filt=".$preg_rep."&&cat=".$_POST['filter']."';</script>";
                        }
                        ?>
