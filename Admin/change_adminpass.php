    ...
    if ($db_pass != $currentpw) {
        ...
        if ($newpw !== $confirmpw) {
            ...
            if (strlen($newpw) && strlen($confirmpw)  < 8) {
                $newpwerr = "Minimum of 8 characters";
                $confirmpwerr = "Minimum of 8 characters";
            }else{
                ...
                if ($db_pass == $currentpw && $newpw == $confirmpw) {
                 ...
                 if ($db_account_type == 1) {
                    echo "<script>window.location.href='admin_page?$encrypted&&notify=Password Changed Successfully!';</script>";
                 }else{
