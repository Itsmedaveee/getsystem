...
if (isset($_POST['submit_btn'])) {
    ...
    mysqli_query($conn, "INSERT INTO mysurveytbl(user_ID,Title,Description,date_created,End_date,Status,Respondents,Survey_type) VALUES('$db_id','$title','$description','$date_now','$enddate','Active','$respondents','employer')");
                
    echo "<script>window.location.href='employer_survey?$encrypted&&notify=Survey Added Successfully!';</script>";
    }
