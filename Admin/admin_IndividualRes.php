        ...
        <div class="navbox">
            ...
            <div class="navpanel">
                ...
                <div class="item">
                    ...
                    <ul>
                    <li><a style="padding-top:17px; padding-bottom:17px; padding-right:100px;" href="Allsurveys"><i class="fa fa-pen"></i> Surveys</a></li>
                    <li><a style="padding-top:17px; padding-bottom:17px; padding-right:100px;" href="Logs"><i class="fa fa-history"></i> Logs</a></li>
                    </ul>
                </div>
                ...
                <div class="item">
                    ...
                    <ul>
                    <li><a style="padding-top:17px; padding-bottom:17px;" href="graduates_survey"><i class="fa fa-pen"></i> Surveys</a></li>
                    <li><a style="padding-top:17px; padding-bottom:17px;" href="List_graduates"><i class="fa fa-user-graduate"></i> List of Graduates</a></li>
                    <li><a style="padding-top:17px; padding-bottom:17px;" href="admin_reports"><i class="fa fa-chart-bar"></i> Reports</a></li>
                    </ul>
                </div>
           ...
           <div class="headcontainer">
                ...
                <div class="bodycontainer">
                    ...
                    ?>
                                ...
                                ?>
                                    <a <?php echo $hideprev; ?> href="Admin_IndividualRes?<?php echo $encrypt.$encrypt1.$encrypt2; ?>&&page=<?php echo $page - 1; ?>&&SID=<?php echo $surveyID; ?>" class="prev">
                                ...
                                ?>
                                    <a <?php echo $hidenext; ?> href="Admin_IndividualRes?<?php echo $encrypt.$encrypt1.$encrypt2; ?>&&page=<?php echo $page + 1; ?>&&SID=<?php echo $surveyID; ?>" class="next">
                                    <img src="../img/next.png" alt=""></a>
                ...
                <!-=====================Footer Done button ------>
                            <div class='divFooter'>
                                    ...
                                    <button name='addQbtn' class='addbtn'><a href='Admin_response?<?php echo $encrypted;?>&&SID=<?php echo $surveyID;?>'>BACK</a></button>
