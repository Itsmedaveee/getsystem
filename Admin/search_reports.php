           ...
           <input type="submit" class="searchbtn" name="search" value="Filter">
               ...
               <table border="0" width="100%" align="center"class="table-stripped" >
                ...
                //***************************Update button code start here */ 
                    ...
                    $sql = "SELECT * from mysurveytbl WHERE $filter LIKE '%$searchdb%' AND User_ID ='$db_id' AND Survey_type = 'graduates' order by Survey_ID desc limit $start_from,$num_per_page ";
